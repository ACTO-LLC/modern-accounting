CREATE TABLE [dbo].[InvoiceLines] (
    ...
    CONSTRAINT [FK_InvoiceLines_Projects] FOREIGN KEY ([ProjectId]) REFERENCES [dbo].[Projects]([Id]),
    CONSTRAINT [FK_InvoiceLines_Classes] FOREIGN KEY ([ClassId]) REFERENCES [dbo].[Classes]([Id])
)
...
CREATE INDEX [IX_InvoiceLines_ProjectId] ON [dbo].[InvoiceLines] ([ProjectId]) WHERE ProjectId IS NOT NULL;
GO

CREATE INDEX [IX_InvoiceLines_ClassId] ON [dbo].[InvoiceLines] ([ClassId]) WHERE ClassId IS NOT NULL;
GO
