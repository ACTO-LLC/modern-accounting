...
[JournalEntryId] UNIQUEIDENTIFIER NULL,
    ...
    CONSTRAINT [FK_Invoices_Terms] FOREIGN KEY ([TermId]) REFERENCES [dbo].[Terms]([Id])
)
...
CREATE INDEX [IX_Invoices_TermId] ON [dbo].[Invoices]([TermId]) WHERE TermId IS NOT NULL
GO
