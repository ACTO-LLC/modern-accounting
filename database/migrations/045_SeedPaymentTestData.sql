...
-- Use fixed RFC 4122 v4-compliant GUIDs for idempotency
DECLARE @CustomerId UNIQUEIDENTIFIER = 'E2E00000-0000-4000-A000-00000000A001';
DECLARE @InvoiceId1 UNIQUEIDENTIFIER = 'E2E00000-0000-4000-A000-00000000B001';
DECLARE @InvoiceId2 UNIQUEIDENTIFIER = 'E2E00000-0000-4000-A000-00000000B002';
DECLARE @InvoiceId3 UNIQUEIDENTIFIER = 'E2E00000-0000-4000-A000-00000000B003';
