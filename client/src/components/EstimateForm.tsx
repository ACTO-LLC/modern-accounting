  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6 flex items-center">
        <button onClick={() => navigate('/estimates')} className="mr-4 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                ...
                <div key={field.id} className="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <button
                      ...
                      className="mt-6 text-red-600 hover:text-red-800 disabled:text-gray-300 dark:disabled:text-gray-600 disabled:cursor-not-allowed"
