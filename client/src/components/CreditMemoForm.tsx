    ...
    <div className="max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow rounded-lg p-6 space-y-6 dark:bg-gray-800">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div>
            <label htmlFor="CreditMemoNumber" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Credit Memo Number</label>
            <input
              id="CreditMemoNumber"
              type="text"
              ...
              placeholder="CM-001"
            />
            {errors.CreditMemoNumber && <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.CreditMemoNumber.message}</p>}
          </div>
