...
// Shared between Azure Functions and client-side calculations
...
export const STATE_TAX_RATES: { [stateCode: string]: StateTaxInfo } = {
  ...
  // Progressive tax states (using top marginal rate for reference)
  AL: { rate: 0.05, hasProgressiveTax: true, name: 'Alabama' },
  AR: { rate: 0.044, hasProgressiveTax: true, name: 'Arkansas' },
  CA: { rate: 0.093, hasProgressiveTax: true, name: 'California' },
